...
class NetHandler:
    ...
    def receive_telemetry_from_rov(self):
        ...
        Mengembalikan data berupa dictionary jika sukses, atau data tiruan jika uji meja.
        """
        try:
            ...
            # Mengembalikan dictionary default dengan key lengkap saat dry-run di meja
            return {
